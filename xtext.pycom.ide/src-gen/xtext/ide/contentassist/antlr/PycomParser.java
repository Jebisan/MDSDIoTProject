...
public class PycomParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PycomGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getActuatorTypeAccess().getTypeAssignment_0(), "rule__ActuatorType__TypeAssignment_0");
			...
			builder.put(grammarAccess.getSensorTypeAccess().getTypeAssignment_0(), "rule__SensorType__TypeAssignment_0");
