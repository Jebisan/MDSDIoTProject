...
public class PycomGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ActuatorTypeElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cTypeActuatorNameParserRuleCall_0_0 = (RuleCall)cTypeAssignment_0.eContents().get(0);
		private final Keyword cColonKeyword_1 = (Keyword)cGroup.eContents().get(1);
		...
		//ActuatorName
		public RuleCall getTypeActuatorNameParserRuleCall_0_0() { return cTypeActuatorNameParserRuleCall_0_0; }
	...
	public class SensorTypeElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cTypeAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cTypeSensorNameParserRuleCall_0_0 = (RuleCall)cTypeAssignment_0.eContents().get(0);
		private final Keyword cColonKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cNameAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cNameIDTerminalRuleCall_2_0 = (RuleCall)cNameAssignment_2.eContents().get(0);
		private final Group cGroup_3 = (Group)cGroup.eContents().get(3);
		...
		//SensorName
		public RuleCall getTypeSensorNameParserRuleCall_0_0() { return cTypeSensorNameParserRuleCall_0_0; }
