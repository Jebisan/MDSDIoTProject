 ...
 * </p>
 * <ul>
 *   <li>{@link xtext.pycom.ActuatorType#getType <em>Type</em>}</li>
...
public interface ActuatorType extends EObject
{
   ...
   * @see #setType(String)
   * @see xtext.pycom.PycomPackage#getActuatorType_Type()
   * @model
   * @generated
   */
  String getType();
  ...
  /**
   * Sets the value of the '{@link xtext.pycom.ActuatorType#getType <em>Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
